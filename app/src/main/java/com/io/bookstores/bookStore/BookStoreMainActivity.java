package com.io.bookstores.bookStore;
...
public class BookStoreMainActivity extends AppCompatActivity implements
    ...
    private void startHome() {
        Drawable unwrappedDrawable = AppCompatResources.getDrawable(BookStoreMainActivity.this, R.drawable.hearts);
        assert unwrappedDrawable != null;
        Drawable wrappedDrawable = DrawableCompat.wrap(unwrappedDrawable);
        DrawableCompat.setTint(wrappedDrawable, getResources().getColor(R.color.gray));
        ivHeart.setImageResource(R.drawable.hearts);
    ...
    private void changeFavouriteColorIcon() {
        ...
        changeIconColor(BookStoreMainActivity.this, R.drawable.hearts, 1);
