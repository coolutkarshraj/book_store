...
public class FavoriteItemsLocalAdapter extends RecyclerView.Adapter<FavoriteItemsLocalAdapter.MyViewHolder> {

    private Context mContext;
    private List<WishListLocalResponseModel> mData;
    userOnlineInfo user;
