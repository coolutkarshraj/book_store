...
import com.io.bookstore.adapter.categoryAdapter.AddressSliderAdapter;
...
public class AddressSliderFragment extends Fragment {
    ...
    private void recyclerViewSetUp() {
        ...
        if (HomeFragment.viewPager.getCurrentItem() == 0) {
            ...
            sizeo = 5 * HomeFragment.viewPager.getCurrentItem();
            i = 5 * HomeFragment.viewPager.getCurrentItem();
        }
